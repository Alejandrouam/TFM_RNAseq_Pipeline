...
all_comparison_list <- list.files(path = paste0(input, "DESeq2/"), pattern = "_deg.csv", recursive = TRUE)
...
deg_comparison_list_edgeR <- list.files(path = paste0(input, "edgeR/"), pattern = "_deg_all", recursive = TRUE)
deg_comparison_list_deseq <- list.files(path = paste0(input, "DESeq2/"), pattern = "_deg_all", recursive = TRUE)
